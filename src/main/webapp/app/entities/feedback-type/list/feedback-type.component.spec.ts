...
import { sampleWithRequiredData } from '../feedback-type.test-samples';
...
describe('FeedbackType Management Component', () => {
  let comp: FeedbackTypeComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(FeedbackTypeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.feedbackTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to feedbackTypeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getFeedbackTypeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getFeedbackTypeIdentifier).toHaveBeenCalledWith(entity);
