...
import { sampleWithRequiredData } from '../rating-scale.test-samples';
...
describe('RatingScale Management Component', () => {
  let comp: RatingScaleComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(RatingScaleComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.ratingScales?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to ratingScaleService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getRatingScaleIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getRatingScaleIdentifier).toHaveBeenCalledWith(entity);
